...
*/
extern void array_mul(unsigned int multiplicandSize, unsigned char *multiplicand, unsigned int multiplierSize, unsigned char *multiplier, unsigned char *product, unsigned int productSize);

extern void array_mul_byte(unsigned int multiplicandSize, unsigned char *multiplicand, unsigned char *multiplier, unsigned char *product);
